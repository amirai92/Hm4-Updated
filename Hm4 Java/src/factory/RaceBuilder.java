...
public class RaceBuilder {
	...
	public Racer buildRacer(String racerType, String name, double maxSpeed, double acceleration,
			utilities.EnumContainer.Color color,int num)
			throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		return (Racer) this.constructor.newInstance(name, maxSpeed, acceleration, color,num);
	}
	...
	public Racer buildDef(String racerType) throws ClassNotFoundException, NoSuchMethodException, SecurityException,
