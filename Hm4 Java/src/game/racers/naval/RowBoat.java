...
public class RowBoat extends Racer implements INavalRacer {
	...
	public RowBoat(String name, double maxSpeed, double acceleration, utilities.EnumContainer.Color color,int num) {
	...
	public Racer clone() {
		...
		RowBoat clone=new RowBoat(this.getName(),this.getMaxSpeed(),this.getAcceleration(),col,this.getNumOfWheels());
		return clone;
	}
